    ...
    <div className="flex flex-col gap-12">
        ...
        <div className="grid md:grid-cols-2 gap-5">
            ...
            <div className="flex flex-col items-center justify-center gap-4 text-center">
                <span className="font-bold text-3xl trackin-tighter">Order takeaway even faster</span>
                <span>Download the MernEats App for faster ordering ans personalised recommendation</span>
